...
class ReadCoilsResponseMessage extends ResponseMessage<ReadCoilsResponse> {
    static class Builder extends ResponseMessage.Builder<ReadCoilsResponseMessage> {
        ...
        @Override
        ReadCoilsResponseMessage build() {
            assert this.values != null;

            return new ReadCoilsResponseMessage(this.values);
        }
    }
    ...
    ReadCoilsResponseMessage(final List<Boolean> values) {
        this.values = values;
    }

    com.digitalpetri.modbus.responses.ReadCoilsResponse toModbusResponse() {
        final byte[] encodedCoilBytes = ModbusProxyBitArrayEncoder.encodeToBinary(this.values);
        return new com.digitalpetri.modbus.responses.ReadCoilsResponse(
