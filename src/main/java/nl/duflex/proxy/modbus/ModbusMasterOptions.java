...
public class ModbusMasterOptions {
    public static class Builder {
        ...
        public ModbusMasterOptions build() {
            assert this.address != null;
            assert this.port != null;

            return new ModbusMasterOptions(this.address, this.port);
        }
    ...
    public ModbusMasterOptions(final InetAddress address, final short port) {
        this.address = address;
        this.port = port;
    }
